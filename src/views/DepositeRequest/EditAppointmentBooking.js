        ...
        <CCol xs="12" md="12" >
          <CCard>
            <CCardHeader className="d-flex justify-content-between">
              <h4>Update Appointment and Booking</h4>
            ...
            <CCardFooter className="text-right">
              <CButton type="submit" size="" color="success" className="mr-2">Update Appointment and Booking</CButton>
            </CCardFooter>
          </CCard>
        </CCol>
      </CRow>
...
export default EditAppointmentBooking
